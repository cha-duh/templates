...
alias cdgarbanzo='cd ~/Documents/palantir/code/garbanzo'
alias sshyoshigato='ssh -p 2222 yoshi@yoshigato.com'
alias sshtomatovm='ssh palantir@tomato-1.adb.one.ptrtech.net'
alias sshgarbanzo='ssh palantir@garbanzo-head.adb.one.ptrtech.net'
alias ytdl='~/Documents/personal/code/youtube/youtube-dl/youtube-dl --restrict-filenames -o "%(autonumber)s-%(title)s.%(ext)s"'
alias bg='open ~/Pictures/reddit-backgrounds/'
alias newalias='vim ~/.bash_profile'
alias hlog='git log --date-order --all --graph --format="%C(green)%h %Creset%C(yellow)%an%Creset %C(blue bold)%ar%Creset %C(red bold)%d%Creset %s"'
alias cdpokemon='cd ~/projects/PokemonGo-Map/PokemonGo-Map-master'
alias pokemongo='python example.py -a ptc -u jrkface9000 -p %0FwTlYl -st 5 -l'
